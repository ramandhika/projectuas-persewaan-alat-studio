<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="insertBarang.aspx.vb" Inherits="insertBarang" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="form1" runat="server">
    <h2 class="text-center mb-4 mt-4">Form Tambah Data Barang Studio</h2>
    ...
    <div class="input-group row justify-content-center">
        <div class="col-7">
            <div class="form-group input-group mb-3">
                ...
                <asp:TextBox ID="tbKode" runat="server" Cssclass="form-control" placeholder="Kode Barang"></asp:TextBox>
            </div>
            <div class="form-group input-group mb-3">
        ...
        <div id="dataBarang" runat="server"></div>
    </div>
        <p>
            &nbsp;
        </p>
